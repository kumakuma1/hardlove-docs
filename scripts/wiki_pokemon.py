...
LEARNSETS_PATH = "../hardlove/data/learnsets/learnsets.json"
...
generate_pokemon_pages(
    evodata_path="../hardlove/armips/data/evodata.s",
    output_dir="docs/pokedex",
    mondata_path="../hardlove/armips/data/mondata.s",
    species_path="../hardlove/include/constants/species.h",
    form_table_path="../hardlove/data/FormToSpeciesMapping.c",
    sprite_root="../hardlove/data/graphics/sprites",
    levelup_path="../hardlove/armips/data/levelupdata.s",
    encounter_path="../hardlove/armips/data/encounters.s"
)
...
if __name__ == "__main__":
    generate_index("../hardlove/include/constants/species.h")